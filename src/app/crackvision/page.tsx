...
export default function CrackVisionPage() {
  ...
  // Clean background effect with subtle grid
  const renderBackground = () => {
    return (
      <div className="fixed inset-0 z-0 bg-gradient-to-br from-slate-50 to-slate-100">
        <div className="absolute inset-0 opacity-10" style={{
          backgroundImage: `linear-gradient(to right, #64748b12 1px, transparent 1px),
                          linear-gradient(to bottom, #64748b12 1px, transparent 1px)`,
